          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <Card className="glass p-8 rounded-2xl border border-white/10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label htmlFor="postalCode" className="text-white mb-2">
                        CEP *
                      </Label>
                      <Input
                        id="postalCode"
              ...
              <Card className="glass p-8 rounded-2xl border border-white/10">
                ...
                {mpInitialized ? (
                  <div className="mercadopago-card-payment">
                    <CardPayment
              ...
              <Card className="glass p-8 rounded-2xl border border-white/10 sticky top-24">
                ...
                <div className="border-t border-white/10 pt-4 mb-6">
                  <div className="flex justify-between items-baseline">
                    ...
                    <span className="text-3xl font-heading font-bold text-white neon-glow" data-testid="checkout-total">
                      {formatPrice(total)}
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  {appliedCoupon && (
                    <p className="text-secondary text-sm">
                      ✓ Cupom aplicado: {(appliedCoupon.discount * 100).toFixed(0)}% de desconto
                    </p>
                  )}
                </div>
